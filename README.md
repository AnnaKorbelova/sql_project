...
- Doplnila jsem dotaz o nový pohled s méně sloupci: kategorii potravin, roky, průměrné ceny potravin a roční mzdy. V dalším pohledu jsem pomocí roky +1 získala předchozí rok a pomocí JOIN jsem napojila tabulku samo na sebe. Dostala jsem meziroční nárůst cen a hodnotu vypočítala a zaokrouhlila pomocí agreg. funkce ROUND. Z nového pohledu jsem pomocí CASE seřadila data do skupin a zjistila potravinu, která zdražuje nejpomaleji.
